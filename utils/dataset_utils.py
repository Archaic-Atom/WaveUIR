...
class WaveUIRTrainDataset(Dataset):
    def __init__(self, args):
        super(WaveUIRTrainDataset, self).__init__()
        self.args = args
        self.rs_ids = []
        self.hazy_ids = []
    ...
    def __getitem__(self, idx):
        ...
        return [clean_name, class_id], degrad_patch, clean_patch
...
class DenoiseTestDataset(Dataset):
    ...
    def __getitem__(self, clean_id):
        ...
        return [clean_name, de_id], noisy_img, clean_img
...
class DerainDehazeDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return [degraded_name, self.task_idx + 1], degraded_img, clean_img
